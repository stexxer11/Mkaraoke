  ...
  const debouncedSearch = useMemo(() =>
    debounce(async (value) => {
      ...
      if (
        ...
        console.log("SEARCH BLOCKED BY COOLDOWN")
  ...
  return (
    <div className="min-h-screen bg-black text-white relative pb-24 overflow-y-auto">
      ...
      <div className="relative px-4 mt-5 space-y-3">
        ...
        <pre className="text-red-400 text-xs overflow-auto max-h-64 bg-black/40 p-3 rounded-xl">
        ...
        {Array.isArray(results) &&
          results
            ...
            .map(song => (
              ...
              <div
                key={song.youtubeId}
                className="flex items-center gap-3 p-3 bg-black/60 rounded-xl"
              >
